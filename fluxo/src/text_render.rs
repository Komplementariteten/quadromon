...
pub fn render_text_small_color(
    scene: &mut Scene,
    text: &str,
    align: Alignment,
    x_off: f64,
...
fn render_text_complex<'a>(
    ...
    variations: Option<&[(&str, f32)]>,
    glyph_transform: Option<Affine>,
) -> f32 {
    let font_opt = match FileRef::new(font.data.as_ref())
        .ok()
        .expect("Failed to load Font as ref.")
    {
